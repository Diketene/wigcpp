...
template <typename... Args> using first_type_t = typename first_type<Args...>::type;

template <typename First, typename... Rest> constexpr decltype(auto) first_value(First &&f) {
