...
struct prime_exponents_view {
  ...
  */
  ...
  void expand_sum3(prime_exponents_view &a, prime_exponents_view &b, prime_exponents_view &c) noexcept;

  void add3_sub(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
                const prime_exponents_view &d) noexcept;

  void add6(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
            const prime_exponents_view &d, const prime_exponents_view &e, const prime_exponents_view &f) noexcept;

  void add7(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
  ...
  void add_sub3(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
                const prime_exponents_view &d) noexcept;

  void sum_sub7(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
                const prime_exponents_view &d, const prime_exponents_view &e, const prime_exponents_view &f,
                const prime_exponents_view &g, const prime_exponents_view &h, int num_blocks) noexcept;

  void sum0_sub6(const prime_exponents_view &a, const prime_exponents_view &b, const prime_exponents_view &c,
                 const prime_exponents_view &d, const prime_exponents_view &e, const prime_exponents_view &f,
