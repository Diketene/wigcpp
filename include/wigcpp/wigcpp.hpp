...
namespace wigcpp {
  ...
  [[nodiscard]] inline double clebsh_gordan(int two_j1, int two_m1, int two_j2, int two_m2, int two_J, int two_M){
    return ::clebsh_gordan(two_j1, two_m1, two_j2, two_m2, two_J, two_M);
  }

  [[nodiscard]] inline double three_j(int two_j1, int two_j2, int two_j3, int two_m1, int two_m2, int two_m3){
    return wig3jj(two_j1, two_j2, two_j3, two_m1, two_m2, two_m3);
  }

  [[nodiscard]] inline double six_j(int two_j1, int two_j2, int two_j3, int two_j4, int two_j5, int two_j6){
    return wig6jj(two_j1, two_j2, two_j3, two_j4, two_j5, two_j6);
  }
  ...
  [[nodiscard]] inline double nine_j(int two_j1, int two_j2, int two_j3, int two_j4, int two_j5, int two_j6, int two_j7, int two_j8, int two_j9){
    return wig9jj(two_j1, two_j2, two_j3, two_j4, two_j5, two_j6, two_j7, two_j8, two_j9);
  }
