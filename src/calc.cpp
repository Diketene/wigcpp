...
namespace wigcpp::internal::calc {
  ...
  void Calculator::calcsum_cg(const global::GlobalFactorialPool &pool, TempStorage &csi, int two_j1, int two_m1, int two_j2, int two_m2, int two_J, int two_M) noexcept{
